...
namespace AcentricPixels.HtmlRenderer.SDL2_CS
{
    public sealed class HtmlContainer : IDisposable
    {
        ...
        {
            get { return _htmlContainerInt.ScrollOffset; }
            set { _htmlContainerInt.ScrollOffset = value; }
        }
        ...
        {
            get { return _htmlContainerInt.Location; }
        ...
        {
            get { return _htmlContainerInt.MaxSize; }
        ...
        {
            get { return _htmlContainerInt.ActualSize; }
        ...
        public List<LinkElementData<RRect>> GetLinks()
        {
            ...
            {
                linkElements.Add(new LinkElementData<RRect>(link.Id, link.Href, link.Rectangle));
            }
            return linkElements;
        }
        ...
        public RRect? GetElementRectangle(string elementId)
        {
            ...
            return r.HasValue ? r.Value : (RRect?)null;
        }
